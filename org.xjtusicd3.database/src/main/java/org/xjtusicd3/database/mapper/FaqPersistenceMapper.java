...
public interface FaqPersistenceMapper extends IBaseDao<FaqPersistence, String>{
	 ...
	 * robot-分类
	 */
	@Select("SELECT faq.faqId,faq.faqTitle FROM faq,classify WHERE faq.faqClassify = classify.classifyId AND faq.faqClassify=#{0} ORDER BY faq.faqCollection DESC LIMIT 3")
