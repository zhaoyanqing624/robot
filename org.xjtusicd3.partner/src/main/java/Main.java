...
public class Main {
    public static String myEmailAccount = "sicd_xiaoduo@163.com";
    public static String myEmailPassword = "hyhzjz06030922";
    public static String myEmailSMTPHost = "smtp.163.com";
    public static String receiveMailAccount = "1134955889@qq.com";
