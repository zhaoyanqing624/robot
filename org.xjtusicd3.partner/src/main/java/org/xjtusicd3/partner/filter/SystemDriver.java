...
//        System.loadLibrary("reg_x64.dll");
        ...
        //显卡
        RegistryKey rt3 = new RegistryKey(LOCALMACHINE, "\\SYSTEM\\ControlSet001\\Control\\Class\\{4D36E968-E325-11CE-BFC1-08002BE10318}\\0000");
        RegistryValue rValue3_1 = rt3.getValue("DriverDesc");
        RegistryValue rValue3_2 = rt3.getValue("DriverVersion");
        RegistryValue rValue3_3 = rt3.getValue("DriverDate");
        ...
        System.out.println(GraphicCard+GraphicCardversion+GraphicCardtime);
        ...
        for(RegistryKey rrt:rts7){
        	...
        	if (rValue7_IPv4!=null&&rValue7_IPv6!=null) {
              ...
              System.out.println("网卡："+Network+Networkversion+Networktime);
			}
        }
