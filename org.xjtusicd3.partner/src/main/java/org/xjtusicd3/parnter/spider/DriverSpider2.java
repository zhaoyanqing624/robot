...
public class DriverSpider2 implements PageProcessor {
    ...
    public void process(Page page) {
			...
			page.putField("oper", page.getHtml().xpath("//div[@class='down_lb']/ul/li[1]/text()").toString());
			page.putField("oper2", page.getHtml().xpath("//div[@class='down_lb']/ul/li[2]/a/text()").toString());
			page.putField("oper3", page.getHtml().xpath("//div[@class='down_lb']/ul/li[3]/text()").toString());
			page.putField("oper4", page.getHtml().xpath("//div[@class='down_lb']/ul/li[4]/text()").toString());
			page.putField("oper5", page.getHtml().xpath("//div[@class='down_lb']/ul/li[5]/a/text()").toString());
			page.putField("oper6", page.getHtml().xpath("//div[@class='down_lb']/ul/li[6]/a/text()").toString());
	    	...
	    	page.putField("size", page.getHtml().xpath("//span[@class='rongj rongj_green']/text()").toString());
