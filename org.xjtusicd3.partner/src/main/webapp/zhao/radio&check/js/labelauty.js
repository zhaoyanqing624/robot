        ...
        function rdochecked(tag) {
            $('.' + tag).each(function (i) {
                ...
                if ($('.' + tag).eq(i).prop("checked") == false) {
                    ...
                    rdobox.find(".check-image").css("background", "url(zhao/radio&check/images/input-unchecked.png)");
                }
                else {
                    rdobox.removeClass("unchecked");
                    rdobox.addClass("checked");
                    rdobox.find(".check-image").css("background", "url(zhao/radio&check/images/input-checked.png)");
                }
            });
        }
    }
