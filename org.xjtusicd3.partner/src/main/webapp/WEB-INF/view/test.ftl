...
li{
    ...
    .sel_container{z-index:9999;font-size:12px;position:absolute;right:300px;top:63px;width:140px;background:rgba(255,255,255,0.8);height:30px;line-height:30px;padding:5px;}
