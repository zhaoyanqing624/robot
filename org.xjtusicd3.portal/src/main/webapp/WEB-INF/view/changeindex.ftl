        ...
        <div class="col-sm-6"style="width:100%;height: 100%">
            <div class="tabs-container">
                <ul class="nav nav-tabs">
                    <li class="active"><a data-toggle="tab" href="#tab-1" aria-expanded="true">变更首页</a>
                    </li>
                    <li class=""><a data-toggle="tab" href="#tab-2" aria-expanded="false">变更中心</a>
                    </li>
                    <li class=""><a data-toggle="tab" href="#tab-3" aria-expanded="false">变更查询</a>
                    </li>
                    <li class=""><a data-toggle="tab" href="#tab-4" aria-expanded="false">变更设置</a>
                    </li>
                </ul>
                        ...
                        <div class="wrapper wrapper-content animated fadeIn">
                            ...
                            <div class="row">
                                <div class="col-sm-6"  style="width: 100%">
                                    <div class="tabs-container">
                                        <ul class="nav nav-tabs">
                                            <li class="active"><a data-toggle="tab" href="#tab-31" aria-expanded="true">未变更</a>
                                            </li>
                                            <li class=""><a data-toggle="tab" href="#tab-32" aria-expanded="false">已变更</a>
                                            </li>
                        ...
                        <div class="wrapper wrapper-content animated fadeIn">
                            ...
                            <div class="row">
                                <div class="col-sm-6"  style="width: 100%">
                                    <div class="tabs-container">
                                        <ul class="nav nav-tabs">
                                            <li class="active"><a data-toggle="tab" href="#tab-41" aria-expanded="true">变更分类</a>
                                            </li>
...
<script>
    $(document).ready(function () {
        ...
        $("#table_list_2").jqGrid({
            ...
            rowNum: 20,
            rowList: [10, 20, 30],
            colNames: ['变更编号', '变更描述', '变更人','变更时间', '风险度', '变更类型','当前状态'],
            colModel: [
                {
                    name: 'id',
                    index: 'id',
                    ...
                    search: true,
                    formatter:'showlink',
                    formatoptions:{baseLinkUrl:"ChangeDetail.html"}
                },
