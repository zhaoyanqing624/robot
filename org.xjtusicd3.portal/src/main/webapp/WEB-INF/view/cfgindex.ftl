        ...
        <div class="col-sm-6"style="width:100%;height: 100%">
            <div class="tabs-container">
                <ul class="nav nav-tabs">
                    <li class="active"><a data-toggle="tab" href="#tab-1" aria-expanded="true">配置首页</a>
                    </li>
                    <li class=""><a data-toggle="tab" href="#tab-2" aria-expanded="false">设备资源</a>
                    </li>
                        ...
                        <div class="wrapper wrapper-content animated fadeIn">
                            ...
                            <div class="row">
                                <div class="col-sm-6"  style="width: 100%">
                                    <div class="tabs-container">
                                        <ul class="nav nav-tabs">
                                            <li class="active"><a data-toggle="tab" href="#tab-21" aria-expanded="true">计算机</a>
                                            </li>
                                            <li class=""><a data-toggle="tab" href="#tab-22" aria-expanded="false">服务器</a>
                                            </li>
