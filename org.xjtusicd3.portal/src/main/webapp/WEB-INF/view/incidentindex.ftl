        ...
        <div class="col-sm-6"style="width:100%;height: 100%">
            <div class="tabs-container">
                <ul class="nav nav-tabs">
                    ...
                    <li class=""><a data-toggle="tab" href="#tab-2" aria-expanded="false">事件中心</a>
                    </li>
                    <li class=""><a data-toggle="tab" href="#tab-3" aria-expanded="false">事件查询</a>
                    </li>
                    <li class=""><a data-toggle="tab" href="#tab-4" aria-expanded="false">事件设置</a>
                    </li>
                </ul>
                        ...
                        <div class="wrapper wrapper-content animated fadeIn">
                            ...
                            <div class="row">
                                <div class="col-sm-6"  style="width: 100%">
                                    <div class="tabs-container">
                                        <ul class="nav nav-tabs">
                                            <li class="active"><a data-toggle="tab" href="#tab-31" aria-expanded="true">待办事件</a>
                                            </li>
                                            <li class=""><a data-toggle="tab" href="#tab-32" aria-expanded="false">已办事件</a>
                                            </li>
                        ...
                        <div class="wrapper wrapper-content animated fadeIn">
                            ...
                            <div class="row">
                                <div class="col-sm-6"  style="width: 100%">
                                    <div class="tabs-container">
                                        <ul class="nav nav-tabs">
                                            <li class="active"><a data-toggle="tab" href="#tab-41" aria-expanded="true">事件分类</a>
                                            </li>
                                            <li class=""><a data-toggle="tab" href="#tab-42" aria-expanded="false">服务级别</a>
                                            </li>
                                                                ...
                                                                <div class="ibox-content">
                                                                    ...
                                                                    <table class="table table-hover">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>D级72小时解决</td>
                                                                            <td class="text-navy"> 48小时</td>
                                                                            <td><button class="btn btn-success">已启用</button> </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>2</td>
                                                                            <td> C级24小时解决
...
<script>
    $(document).ready(function () {
        ...
        $("#table_list_2").jqGrid({
            ...
            rowNum: 20,
            rowList: [10, 20, 30],
            colNames: ['事件编号', '事件描述', '发起人','登记时间', '优先级', '事件分类' ],
            colModel: [
                {
                    name: 'id',
                    index: 'id',
                    ...
                    search: true,
                    formatter:'showlink',
                    formatoptions:{baseLinkUrl:"incidentdetail3.html"}
                },

                {
                    ...
                    width: 120,
                    formatter:'showlink',
                    formatoptions:{baseLinkUrl:"incidentdetail.html"}
                },
                {
                    name: 'Qname',
                    index: 'Qname',
...
<script>
    $(document).ready(function () {
        ...
        $("#table_list_3").jqGrid({
            ...
            rowNum: 20,
            rowList: [10, 20, 30],
            colNames: ['事件编号', '事件描述', '发起人','登记时间', '优先级', '事件分类', '解决人'],
            colModel: [
                {
                    name: 'id',
                    index: 'id',
                    ...
                    search: true,
                    formatter:'showlink',
                    formatoptions:{baseLinkUrl:"incidentdetail2.html"}
                },
