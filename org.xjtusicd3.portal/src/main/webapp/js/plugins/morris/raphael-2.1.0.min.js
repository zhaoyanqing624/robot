(function (a) {
    ...
    function cq() {
        return this.x + q + this.y + q + this.width + " 脳 " + this.height
    }
    ...
    function bv(a, b, c) {
        function d() {
            var e = Array.prototype.slice.call(arguments, 0), f = e.join("鈵€"), h = d.cache = d.cache || {}, i = d.count = d.count || [];
            if (h[g](f)) {
                bu(i, f);
                return c ? c(h[f]) : h[f]
            }
    ...
    var bo = function (b) {
        if (a.vml) {
            ...
            i.title = "Rapha毛l Colour Picker", i.style.display = "none", h.doc.body.appendChild(i), bo = bv(function (a) {
                i.style.color = a;
    ...
    a.getRGB = bv(function (b) {
        ...
        if (k) {
            ...
            if (k[5]) {
                j = k[5][s](W), d = Q(j[0]), j[0].slice(-1) == "%" && (d *= 2.55), e = Q(j[1]), j[1].slice(-1) == "%" && (e *= 2.55), f = Q(j[2]), j[2].slice(-1) == "%" && (f *= 2.55), (j[0].slice(-3) == "deg" || j[0].slice(-1) == "掳") && (d /= 360), k[1].toLowerCase().slice(0, 4) == "hsba" && (h = Q(j[3])), j[3] && j[3].slice(-1) == "%" && (h /= 100);
                return a.hsb2rgb(d, e, f, h)
            }
            if (k[6]) {
                j = k[6][s](W), d = Q(j[0]), j[0].slice(-1) == "%" && (d *= 2.55), e = Q(j[1]), j[1].slice(-1) == "%" && (e *= 2.55), f = Q(j[2]), j[2].slice(-1) == "%" && (f *= 2.55), (j[0].slice(-3) == "deg" || j[0].slice(-1) == "掳") && (d /= 360), k[1].toLowerCase().slice(0, 4) == "hsla" && (h = Q(j[3])), j[3] && j[3].slice(-1) == "%" && (h /= 100);
    ...
    a.findDotsAtSegment = function (a, b, c, d, e, f, g, h, i) {
        ...
        return function () {
            eve("raphael.log", null, "Rapha毛l: you are calling to method 鈥�" + a + "鈥� of removed object", a)
        }
    };
    ...
    z.prototype = A, A.constructor = z, a._engine.path = function (a, b) {
        ...
        this.bottom = this.top = null, (this.desc = q("desc")).appendChild(a._g.doc.createTextNode("Created with Rapha毛l " + a.version)), b.appendChild(this.desc), b.appendChild(this.defs = q("defs"))
